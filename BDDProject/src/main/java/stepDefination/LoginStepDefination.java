  ...
  @Given("^User is already in loginpage$") public void
  user_is_already_in_loginpage() throws Throwable {
  System.setProperty("webdriver.chrome.driver",
  "C:\\Users\\vineelaa\\Downloads\\chromedriver_win32\\chromedriver.exe"); 
  driver = new ChromeDriver(); 
  driver.get("https://classic.crmpro.com/index.html");
  driver.manage().window().maximize(); }
  
  @When("^title of login page is FreeCrm$") public void
  title_of_login_page_is_FreeCrm() throws Throwable { 
  ...
  user_clicks_on_login_button() throws Throwable {
